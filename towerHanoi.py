...
def tower_of_hanoi_recursive(
    board, board_size, board_color, board_width, start, end, temp
):
    # base case
    if start == end:
        return
    # recursive case
        ...
        tower_of_hanoi_recursive(
            board, board_size, board_color, board_width, start, temp, end
        )
        ...
        tower_of_hanoi_recursive(
            board, board_size, board_color, board_width, temp, end, start
        )
...
def tower_of_hanoi(board, board_size, board_color, board_width):
    ...
    tower_of_hanoi_recursive(
        board, board_size, board_color, board_width, 0, board_size - 1, board_size - 1
    )
